<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- jenis kelamin -->
        <div>
            <x-input-label for="Jenis Kelamin" :value="__('jenis_kelamin')" />
            <x-text-input id="jenis_kelamin" class="block mt-1 w-full" type="select" name="jenis_kelamin" :value="old('jenis_kelamin')" required autofocus autocomplete="jenis_kelamin" />
